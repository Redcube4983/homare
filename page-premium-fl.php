...
<nav class="breadcrumb">
				<ul>
					...
					<li><a href="<?php echo esc_url( home_url( 'cosme' ) ); ?>">会津ほまれ化粧水</a></li>
					<li><span>ほまれPREMIUM化粧水</span></li>
				</ul>
</nav>
<h1 class="page-title">ほまれPREMIUM化粧水</h1>
</div>
<section class="premium-fl-intro">
...
<p class="premium-fl-sec2-speech">くすみやシミの悩みに加え、年齢とともに「たるみ」が気になり始めた、ほまれ酒造の女将 Madame Mikiko
	...
	<small style="font-size: 1.6rem; text-align: left; line-height:3; color:#fff ;width: 100%; display: block;">※1：年齢を感じさせない肌のこと ※2：角質層まで ※3：年齢肌に応じたケアのこと</small>
</p>
...
<section class="premium-fl-sec4-sec1">
<div id="kodawari">
<div class="kodawari-box">
<h3>日本酒を90％に増量</h3>
<p>「ほまれ化粧水」の保湿力のカギである日本酒の配合量を60％から90％に増量しました。さっぱりとした使用感なのに、アミノ酸豊富な美肌成分を含む日本酒<sup>※4</sup>が、しっとり肌に導きます。
</p>
<figure>
...
<div class="kodawari-box">
<h3>贅沢ローズオットー精油</h3>
<p>ローズオットー精油<sup>※8</sup>は、ダマスクローズを原料とし、 1グラムに2,600本ものバラを使用して造られた、お肌にうれしい希少な精油です。中世ヨーロッパでは柔らかく、ハリのある肌を保つ薬として利用されていました。
</p>
<figure>
...
<div class="kodawari-box">
<h3>美肌植物・美容成分配合</h3>
<p>米セラミド<sup>※9</sup>を配合し、保湿力を強化<sup>※10</sup>しました。ウワウルシエキス<sup>※11</sup>・ザクロ果皮エキス<sup>※12</sup>・月桃葉エキス<sup>※13</sup>・紫根エキス<sup>※14</sup>・α-アルブチン<sup>※15</sup>・アセチルグルコサミン<sup>※16</sup>・
ナイアシンアミド<sup>※17</sup>・グリシルグリシン<sup>※18</sup>など、配合成分の全てが乾燥によるくすみが気になる肌にうるおいを与え、年齢を重ねた肌をサポートします。
</p>
<figure>
<img src="<?php echo( get_stylesheet_directory_uri() ); ?>/images/premium-fl/premium-fl_image04.jpg" width="100%" alt="日本酒を90％に増量"><small style="text-align: left; line-height:1.5; color:#000;width: 100%; display: block;">画像はイメージです。</small></figure>
</div>
<small style="text-align: left; line-height:2; color:#000; width: 100%; display: block; margin: 0 0 50px; font-size: 1.4rem;">※4：コメ発酵液（湿潤剤） ※5：トリフルオロ酢酸テトラデシルアミノブチロイルバリルアミノ酪酸ウレア（湿潤剤） ※6：水溶性プロテオグリカン（湿潤剤） ※7：フランスカイガンショウ樹皮エキス（湿潤剤） ※8：ダマスクバラ花油（着香剤） ※9：グルコシルセラミド（湿潤剤）、※10：従来品比較、※11：ウワウルシ葉エキス（湿潤剤）、※12：ザクロ果皮エキス（湿潤剤）、※13：ゲットウ葉エキス（湿潤剤） ※14：ムラサキ根エキス（湿潤剤） ※15：α－アルブチン（湿潤剤） ※16：アセチルグルコサミン（湿潤剤） ※17：ナイアシンアミド（湿潤剤） ※18：グリシルグリシン（湿潤剤）</small>
</div>
</section>
<section class="premium-fl-sec4-sec2">
<h3>水の代わりに日本酒<sup style="line-height: 1;"><small style="line-height: 1;">※4</small></sup>だけを使う贅沢</h3>
<h3>品よく香るローズオットー精油<sup style="line-height: 1;"><small style="line-height: 1;">※8</small></sup></h3>
<h4>まさに“プレミアム”の名に<br class="sp sp2"/>ふさわしいリッチな化粧水</h4>
</section>
<section class="premium-fl-sec4-sec3">
<div class="squareBox">
<div class="content">
<p>肌なじみの良さを<br>実感できる使用感</p>
<h3>さっぱりだけど、<br>肌に潤いが満ちる!</h3>
</div>
</div>
<div class="squareBox">
<div class="content">
...
<div class="squareBox">
<div class="content">
<p>肌荒れの方でも使える<br>肌にやさしい成分</p>
<h3>必要なものだけを<br>厳選して<br>高配合!</h3>
</div>
</div>
</section>
<section class="premium-fl-sec4-sec4">
<h3>6つの無添加にも<br class="sp">こだわりました</h3>
<div class="squareBox">
<div class="content">
<p>香料<br>不使用</p>
</div>
...
<section class="premium-fl-sec5">
<p class="premium-fl-sec5-text">酒蔵の女将が開発、日本酒で造られた<br>
「秘伝の化粧水」シリーズ第2弾！
</p>
...
<img class="premium-fl-bg" src="<?php echo( get_stylesheet_directory_uri() ); ?>/images/premium-fl/premium-fl-bg.png" width="100%" alt="ほまれPREMIUM化粧水">
</figure>
</section>
</main>
<?php get_footer();?>